...
There are two types of reports that can be generated using DDEV commands:
```
...
These are only useful when the system gathered significant amount of data across several months.
