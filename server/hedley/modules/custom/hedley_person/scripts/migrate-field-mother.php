...
/**
 * @file
 * Migrate existing field_mother to populate field_person.
 *
 * Run migrate-mothers and migrate-children first.
 *
 * Drush scr
 * profiles/hedley/modules/custom/hedley_person/scripts/migrate-field-mother.php.
 */
...
while (TRUE) {
  ...
  foreach ($nodes as $node) {
    ...
    $measurement->field_person->set($measurement->field_mother->field_person->value());
    $measurement->save();
