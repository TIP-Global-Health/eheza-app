 ...
 *   The node ID of the health center.
 */
function get_duplicates($village = NULL, $health_center_id) {
...
foreach ($villages as $village) {
  ...
  $results = get_duplicates($village, $health_center_id);
...
$table = new HedleyAdminTextTable(['Node ID', 'First Name', 'Second Name', 'Birth Date', 'Village']);
