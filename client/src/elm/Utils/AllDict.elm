module Utils.AllDict exposing
    ( AllDict
    , empty, singleton, insert, update, remove
    , isEmpty, member, get, size, getOrd, eq, fullEq
...
Insert, remove, and query operations all take _O(log n)_ time. AllDictionary
...
min dict =
    case dict of
        ...
        RBEmpty_elm_builtin _ v ->
            Debug.todo "(min Empty) is not defined"
...
max dict =
    case dict of
        ...
        RBEmpty_elm_builtin _ _ ->
            Debug.todo "(max Empty) is not defined"
...
moreBlack color =
    case color of
        ...
        BBlack ->
            Debug.todo "Can't make a double black node more black!"
...
lessBlack color =
    case color of
        ...
        NBlack ->
            Debug.todo "Can't make a negative black node less black!"
    ...
    case ( l, r ) of
        ( RBEmpty_elm_builtin _ ord, RBEmpty_elm_builtin _ _ ) ->
            case c of
                ...
                Black ->
                    RBEmpty_elm_builtin LBBlack ord

                _ ->
                    Debug.todo "cannot have bblack or nblack nodes at this point"
...
redden t =
    case t of
        RBEmpty_elm_builtin _ _ ->
            Debug.todo "can't make a Leaf red"
