module Measurement.Utils exposing (OutsideCareConfig, allNextStepsTasks, allVaccineDoses, allVaccineTypes, allVaccineTypesByGender, behindOnVaccinationsByHistory, behindOnVaccinationsByProgress, behindOnVaccinationsByProgressFromChildScoreboard, behindOnVaccinationsByProgressFromWellChild, bloodGpRsResultFormAndTasks, bloodGpRsResultFormWithDefault, bloodGpRsResultInputsAndTasks, bloodGpRsTestFormWithDefault, bloodSmearResultInputsAndTasks, bloodSmearResultNotSet, bloodSmearResultSet, childDiagnosedWithMalnutrition, cholesterolMmolLToMgdLRatio, contentAndTasksForPerformedLaboratoryTest, contentAndTasksLaboratoryResultConfirmation, contentAndTasksLaboratoryTestInitial, contentAndTasksLaboratoryTestKnownAsPositive, contentAndTasksLaboratoryUniversalTestInitial, contentAndTasksLaboratoryUniversalTestKnownAsPositive, contributingFactorsFormWithDefault, corePhysicalExamFormWithDefault, creatinineResultFormAndTasks, creatinineResultFormWithDefault, emptyContentAndTasksForPerformedLaboratoryTestConfig, emptyContentAndTasksForPerformedLaboratoryUniversalTestConfig, emptyContentAndTasksLaboratoryResultConfig, emptyContentAndTasksLaboratoryTestInitialConfig, emptyContentAndTasksLaboratoryUniversalTestInitialConfig, expectCounselingActivity, expectNCDAStep, expectParticipantConsent, expectUniversalTestResultTask, expectVaccineDoseForPerson, expectVaccineForPerson, familyPlanningFormWithDefault, fbfFormToValue, fbfValueToForm, filterNutritionAssessmentsFromFollowUpValue, filterNutritionAssessmentsFromNutritionValue, followUpFormWithDefault, fromAdministrationNote, fromChildMeasurementData, fromContributingFactorsValue, fromHealthEducationValue, fromHeightValue, fromListWithDefaultValue, fromMotherMeasurementData, fromMuacValue, fromNCDAValue, fromNutritionFollowUpValue, fromNutritionValue, fromSendToHCValue, fromWeightValue, generateAssembledDataForChildScoreboard, generateAssembledDataForWellChild, generateFutureVaccinationsData, generateGroupNutritionAssessmentEntries, generateIndividualNutritionAssessmentEntries, generateSuggestedVaccinations, generateVaccinationProgressDictByChildScoreboard, generateVaccinationProgressDictByWellChild, generateVaccinationProgressDictsForChildScoreboard, generateVaccinationProgressDictsForWellChild, generateVaccinationProgressForChildScoreboard, generateVaccinationProgressForVaccine, generateVaccinationProgressForWellChild, getAllDosesForVaccine, getChildForm, getInputConstraintsHeight, getInputConstraintsMuac, getInputConstraintsWeight, getIntervalForVaccine, getLastDoseForVaccine, getMotherForm, getNextVaccineDose, getPreviousMeasurements, hba1cTestFormWithDefault, healthEducationFormWithDefault, heightFormWithDefault, hemoglobinResultFormAndTasks, hemoglobinResultFormWithDefault, hemoglobinResultInputsAndTasks, hemoglobinTestFormWithDefault, hepatitisBResultFormAndTasks, hepatitisBResultFormWithDefault, hepatitisBTestFormWithDefault, hivPCRResultFormAndTasks, hivPCRResultFormWithDefault, hivPCRResultInputsAndTasks, hivPCRTestFormWithDefault, hivResultFollowUpInputsAndTasks, hivResultFollowUpsFormAndTasks, hivResultFormAndTasks, hivResultFormWithDefault, hivResultInputsAndTasks, hivTestFormWithDefault, hivTestUniversalFormWithDefault, immunisationTaskToVaccineType, initialVaccinationDateByBirthDate, isBehindOnVaccinationsByProgress, isTestResultValid, laboratoryTaskIconClass, lactationFormToSigns, lactationSignsToForm, latestVaccinationDataForVaccine, lipidPanelResultFormAndTasks, lipidPanelResultFormWithDefault, liverFunctionResultFormAndTasks, liverFunctionResultFormWithDefault, malariaResultFormAndTasks, malariaResultFormWithDefault, malariaTestFormWithDefault, medicationAdministrationFormInputsAndTasks, medicationAdministrationFormWithDefault, mergeNutritionAssessmentEntries, mergeVaccinationProgressDicts, muacFormWithDefault, muacMeasurementIsOff, ncdaFormWithDefault, ncdaSteps, nextDoseForVaccine, nextVaccinationDataForVaccine, noOutsideCareMedicationOptions, nonRDTFormInputsAndTasks, nonRDTFormWithDefault, nutritionCaringFormWithDefault, nutritionFeedingFormWithDefault, nutritionFollowUpFormWithDefault, nutritionFoodSecurityFormWithDefault, nutritionFormWithDefault, nutritionHygieneFormWithDefault, ongoingTreatmentReviewFormWithDefault, outsideCareFormInputsAndTasks, outsideCareFormInputsAndTasksDiagnoses, outsideCareFormInputsAndTasksMedications, outsideCareFormWithDefault, outsideCareMedicationOptionsAnemia, outsideCareMedicationOptionsHIV, outsideCareMedicationOptionsHypertension, outsideCareMedicationOptionsMalaria, outsideCareMedicationOptionsSyphilis, partnerARVViralLoadInputsAndTasks, partnerHIVResultFollowUpInputsAndTasks, partnerHIVResultFollowUpsFormAndTasks, partnerHIVResultFormAndTasks, partnerHIVResultFormWithDefault, partnerHIVResultInputsAndTasks, partnerHIVTestFormWithDefault, pregnancyTestFormWithDefault, prenatalRDTFormInputsAndTasks, prerequisiteByImmediateResultInputsAndTasks, randomBloodSugarFormWithDefault, randomBloodSugarResultFormAndTasks, randomBloodSugarResultFormWithDefault, randomBloodSugarResultInputsAndTasks, randomBloodSugarTestPrerequisitesInputsAndTasks, randomBloodSugarUniversalFormWithDefault, renderDatePart, resoloveLastScheduledImmunizationVisitDate, resolveChildANCPregnancyData, resolveIndividualNutritionValue, resolveIndividualWellChildValue, resolveLabTestDate, resolveMedicationsNonAdministrationReasons, resolveNCDASteps, resolveRunConfirmedByLabTechFromValue, resultFormHeaderSection, sendToHCFormWithDefault, standardTestResultInputsAndTasks, syphilisResultFollowUpInputsAndTasks, syphilisResultFollowUpsFormAndTasks, syphilisResultFormAndTasks, syphilisResultFormWithDefault, syphilisResultInputsAndTasks, syphilisTestFormWithDefault, testNotPerformedByWhyNotAtExecutionNote, testPerformedByExecutionNote, testPerformedByValue, testPrerequisitesByImmediateResult, toAdministrationNote, toAdministrationNoteWithDefault, toBloodGpRsResultValue, toBloodGpRsResultValueWithDefault, toBloodGpRsTestValue, toBloodGpRsTestValueWithDefault, toContributingFactorsValue, toContributingFactorsValueWithDefault, toCorePhysicalExamValue, toCorePhysicalExamValueWithDefault, toCreatinineResultValue, toCreatinineResultValueWithDefault, toCreatinineTestValueWithEmptyResults, toEverySet, toFamilyPlanningValue, toFamilyPlanningValueWithDefault, toFollowUpValue, toFollowUpValueWithDefault, toHIVPCRResultValue, toHIVPCRResultValueWithDefault, toHIVPCRTestValue, toHIVPCRTestValueWithDefault, toHIVResultValue, toHIVResultValueWithDefault, toHIVTestValue, toHIVTestValueUniversal, toHIVTestValueUniversalWithDefault, toHIVTestValueWithDefault, toHbA1cTestValue, toHbA1cTestValueWithDefault, toHealthEducationValue, toHealthEducationValueWithDefault, toHeightValue, toHeightValueWithDefault, toHemoglobinResultValue, toHemoglobinResultValueWithDefault, toHemoglobinTestValue, toHemoglobinTestValueWithDefault, toHepatitisBResultValue, toHepatitisBResultValueWithDefault, toHepatitisBTestValue, toHepatitisBTestValueWithDefault, toLipidPanelResultValue, toLipidPanelResultValueWithDefault, toLipidPanelTestValueWithEmptyResults, toLiverFunctionResultValue, toLiverFunctionResultValueWithDefault, toLiverFunctionTestValueWithEmptyResults, toMalariaResultValue, toMalariaResultValueWithDefault, toMalariaTestValue, toMalariaTestValueWithDefault, toMuacValue, toMuacValueWithDefault, toNCDAValue, toNCDAValueWithDefault, toNonRDTValueWithDefault, toNutritionCaringValue, toNutritionCaringValueWithDefault, toNutritionFeedingValue, toNutritionFeedingValueWithDefault, toNutritionFollowUpValue, toNutritionFollowUpValueWithDefault, toNutritionFoodSecurityValue, toNutritionFoodSecurityValueWithDefault, toNutritionHygieneValue, toNutritionHygieneValueWithDefault, toNutritionValue, toNutritionValueWithDefault, toOngoingTreatmentReviewValue, toOngoingTreatmentReviewValueWithDefault, toOutsideCareValue, toOutsideCareValueWithDefault, toPartnerHIVResultValue, toPartnerHIVResultValueWithDefault, toPartnerHIVTestValue, toPartnerHIVTestValueWithDefault, toPregnancyTestValue, toPregnancyTestValueWithDefault, toRandomBloodSugarResultValue, toRandomBloodSugarResultValueWithDefault, toRandomBloodSugarTestValue, toRandomBloodSugarTestValueUniversal, toRandomBloodSugarTestValueUniversalWithDefault, toRandomBloodSugarTestValueWithDefault, toSendToHCValue, toSendToHCValueWithDefault, toSyphilisResultValue, toSyphilisResultValueWithDefault, toSyphilisTestValue, toSyphilisTestValueWithDefault, toUrineDipstickResultValue, toUrineDipstickResultValueWithDefault, toUrineDipstickTestValue, toUrineDipstickTestValueUniversal, toUrineDipstickTestValueUniversalWithDefault, toUrineDipstickTestValueWithDefault, toVaccinationValue, toVaccinationValueWithDefault, toVitalsValue, toVitalsValueWithDefault, toWeightValue, toWeightValueWithDefault, treatmentReviewCustomReasonsForNotTakingInputsAndTasks, treatmentReviewInputsAndTasks, triglyceridesMmolLToMgdLRatio, urineDipstickFormWithDefault, urineDipstickResultFormAndTasks, urineDipstickResultFormWithDefault, urineDipstickResultInputsAndTasks, urineDipstickUniversalFormWithDefault, vaccinationFormDynamicContentAndTasks, vaccinationFormWithDefault, vaccineDoseToComparable, viewAdministeredMedicationCustomLabel, viewAdministeredMedicationQuestion, viewBloodGpRsTestForm, viewHIVPCRTestForm, viewHIVTestForm, viewHIVTestUniversalForm, viewHbA1cTestForm, viewHemoglobinTestForm, viewHepatitisBTestForm, viewMalariaTestForm, viewNonRDTForm, viewNonRDTFormCheckKnownAsPositive, viewOutsideCareMedicationOption, viewOutsideCareMedicationOptionWithDosage, viewPartnerHIVTestForm, viewPregnancyTestForm, viewRandomBloodSugarTestForm, viewRandomBloodSugarTestUniversalForm, viewReinforceAdherenceQuestion, viewSelectInput, viewSyphilisTestForm, viewUrineDipstickTestForm, viewUrineDipstickTestUniversalForm, vitalsFormWithDefault, wasFirstDoseAdministeredWithin14DaysFromBirthByVaccinationForm, wasInitialOpvAdministeredByVaccinationProgress, weightFormWithDefault, withinConstraints)
