...
type BackendAuthorityEntity
    ...
    | BackendAuthorityFamilyEncounter (BackendEntity FamilyEncounter)
    | BackendAuthorityFamilyFBFMother (BackendEntity FamilyFBFMother)
    | BackendAuthorityFamilyFBFChild (BackendEntity FamilyFBFChild)
