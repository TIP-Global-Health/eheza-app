...
type BackendAuthorityEntity
    ...
    | BackendAuthorityChildScoreboardHeight (BackendEntity ChildScoreboardHeight)
    ...
    | BackendAuthorityChildScoreboardMuac (BackendEntity ChildScoreboardMuac)
    | BackendAuthorityChildScoreboardNCDA (BackendEntity ChildScoreboardNCDA)
    | BackendAuthorityChildScoreboardNutrition (BackendEntity ChildScoreboardNutrition)
    ...
    | BackendAuthorityChildScoreboardWeight (BackendEntity ChildScoreboardWeight)
