...
type BackendAuthorityEntity
    ...
    | BackendAuthorityAcuteIllnessENT (BackendEntity AcuteIllnessENT)
    | BackendAuthorityAcuteIllnessEyes (BackendEntity AcuteIllnessEyes)
    | BackendAuthorityAcuteIllnessFollowUp (BackendEntity AcuteIllnessFollowUp)
    | BackendAuthorityAcuteIllnessGU (BackendEntity AcuteIllnessGU)
    ...
    | BackendAuthorityAcuteIllnessOral (BackendEntity AcuteIllnessOral)
