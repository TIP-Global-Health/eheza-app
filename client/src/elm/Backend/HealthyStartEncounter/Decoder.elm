module Backend.HealthyStartEncounter.Decoder exposing (decodeHealthyStartEncounter, decodeHealthyStartEncounterType, decodePrenatalDiagnosis)
...
decodeHealthyStartEncounter =
    ...
    succeed HealthyStartEncounter
        ...
        |> required "prenatal_encounter_type" (decodeWithFallback NurseEncounter decodeHealthyStartEncounterType)
        ...
        |> optional "prenatal_indicators" (decodeEverySet decodeHealthyStartIndicator) EverySet.empty
