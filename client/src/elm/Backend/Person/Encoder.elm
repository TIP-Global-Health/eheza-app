...
encodePerson person =
    ...
    , ( "spouse_name", maybe string person.spouseName )
    , ( "spouse_phone_number", maybe string person.spousePhoneNumber )
    , ( "next_of_kin_name", maybe string person.nextOfKinName )
    , ( "next_of_kin_phone_number", maybe string person.nextOfKinPhoneNumber )
