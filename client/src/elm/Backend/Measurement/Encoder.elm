module Backend.Measurement.Encoder exposing (encodeAbdomenCPESign, encodeAcuteFindings, encodeAcuteFindingsGeneralSign, encodeAcuteFindingsRespiratorySign, encodeAcuteFindingsValue, encodeAcuteIllnessContactsTracing, encodeAcuteIllnessContactsTracingValue, encodeAcuteIllnessCoreExam, encodeAcuteIllnessCoreExamValue, encodeAcuteIllnessDangerSign, encodeAcuteIllnessDangerSigns, encodeAcuteIllnessDangerSignsValue, encodeAcuteIllnessFollowUp, encodeAcuteIllnessFollowUpValue, encodeAcuteIllnessMeasurement, encodeAcuteIllnessMuac, encodeAcuteIllnessNutrition, encodeAcuteIllnessNutritionValue, encodeAcuteIllnessTraceContact, encodeAcuteIllnessTraceContactValue, encodeAcuteIllnessVitals, encodeAdministrationNote, encodeAdverseEvent, encodeAppointmentConfirmation, encodeAppointmentConfirmationValue, encodeAttendance, encodeAttendanceValue, encodeAvoidingGuidanceReason, encodeBilirubinValue, encodeBirthDefect, encodeBirthPlan, encodeBirthPlanSign, encodeBirthPlanValue, encodeBloodGpRsTestValue, encodeBloodGroup, encodeBloodSmearResult, encodeBreastExam, encodeBreastExamSign, encodeBreastExamValue, encodeBreastfeedingSign, encodeBreastfeedingValue, encodeCHWPregnancyTestValue, encodeCSectionReason, encodeCSectionScar, encodeCall114, encodeCall114Sign, encodeCall114Value, encodeChildFbf, encodeChildScoreboardBCGImmunisation, encodeChildScoreboardDTPImmunisation, encodeChildScoreboardDTPStandaloneImmunisation, encodeChildScoreboardIPVImmunisation, encodeChildScoreboardMRImmunisation, encodeChildScoreboardMeasurement, encodeChildScoreboardNCDA, encodeChildScoreboardOPVImmunisation, encodeChildScoreboardPCV13Immunisation, encodeChildScoreboardRotarixImmunisation, encodeContactTraceItem, encodeContactTraceItemToString, encodeContributingFactors, encodeContributingFactorsSign, encodeContributingFactorsValueWithType, encodeCorePhysicalExam, encodeCorePhysicalExamValueWithType, encodeCounselingSession, encodeCounselingSessionValue, encodeCovidTesting, encodeCovidTestingValue, encodeCreatinineTestValue, encodeDangerSign, encodeDangerSigns, encodeDangerSignsValue, encodeDeliveryComplication, encodeDischargeType, encodeDistributionNotice, encodeDistributionNoticeAsString, encodeECDSign, encodeExposure, encodeExposureSign, encodeExposureValue, encodeEyesCPESign, encodeFamilyPlanning, encodeFamilyPlanningSign, encodeFamilyPlanningSignAsString, encodeFamilyPlanningValueWithType, encodeFbfValueWithType, encodeFetalPresentation, encodeFollowUp, encodeFollowUpOption, encodeFollowUpValueWithType, encodeFoodGroup, encodeGUExamSign, encodeGUExamValue, encodeGlucoseValue, encodeGroupHealthEducation, encodeGroupMeasurement, encodeGroupNCDA, encodeGroupSendToHC, encodeHCContact, encodeHCContactSign, encodeHCContactValue, encodeHCRecommendation, encodeHIVDiagnosisSign, encodeHIVDiagnostics, encodeHIVDiagnosticsValue, encodeHIVFollowUp, encodeHIVHealthEducation, encodeHIVHealthEducationSign, encodeHIVHealthEducationValue, encodeHIVMeasurement, encodeHIVMedication, encodeHIVMedicationValue, encodeHIVPCRTestValue, encodeHIVPrescribedMedication, encodeHIVReferral, encodeHIVSymptom, encodeHIVSymptomReview, encodeHIVSymptomReviewValue, encodeHIVTestValue, encodeHIVTreatmentReview, encodeHIVTreatmentSign, encodeHaemoglobinValue, encodeHairHeadCPESign, encodeHandsCPESign, encodeHbA1cTestValue, encodeHeadCircumferenceInCm, encodeHeadCircumferenceValue, encodeHealthEducation, encodeHealthEducationSign, encodeHealthEducationValueWithType, encodeHeartCPESign, encodeHeight, encodeHeightInCm, encodeHeightValueWithType, encodeHemoglobinTestValue, encodeHepatitisBTestValue, encodeHomeVisitMeasurement, encodeIllnessSymptom, encodeImageUrlWithType, encodeIsolation, encodeIsolationSign, encodeIsolationValue, encodeKetoneValue, encodeLaboratoryTest, encodeLabsResultsReviewState, encodeLabsResultsValue, encodeLactation, encodeLactationSign, encodeLactationValue, encodeLastMenstrualPeriod, encodeLastMenstrualPeriodValue, encodeLateFirstANCVisitReason, encodeLegsCPESign, encodeLeukocytesValue, encodeLipidPanelTestValue, encodeLiverFunctionTestValue, encodeLmpDateNotConfidentReason, encodeLungsCPESign, encodeMainIncomeSource, encodeMainWaterSource, encodeMalariaPrevention, encodeMalariaPreventionSign, encodeMalariaPreventionValue, encodeMalariaTestValue, encodeMalariaTesting, encodeMalariaTestingValue, encodeMeasurement, encodeMeasurementNote, encodeMedicalCondition, encodeMedicalHistory, encodeMedicalHistoryInfectiousDisease, encodeMedicalHistoryMentalHealthIssue, encodeMedicalHistoryPhysicalCondition, encodeMedicalHistorySign, encodeMedicalHistoryValue, encodeMedication, encodeMedicationCausingHypertension, encodeMedicationDistribution, encodeMedicationDistributionSign, encodeMedicationDistributionValue, encodeMedicationNonAdministrationSign, encodeMedicationSign, encodeMedicationTreatingDiabetes, encodeMedicationTreatingHypertension, encodeMedicationTreatmentSign, encodeMedicationValue, encodeMotherFbf, encodeMuac, encodeMuacInCm, encodeMuacValueWithType, encodeNCDASign, encodeNCDAValueWithType, encodeNCDCoMorbidities, encodeNCDCoMorbiditiesValue, encodeNCDCoreExam, encodeNCDCreatinineTest, encodeNCDDangerSign, encodeNCDDangerSigns, encodeNCDDangerSignsValue, encodeNCDFamilyHistory, encodeNCDFamilyHistorySign, encodeNCDFamilyHistoryValue, encodeNCDFamilyPlanning, encodeNCDGroup1Symptom, encodeNCDGroup2Symptom, encodeNCDGuidanceSign, encodeNCDHIVTest, encodeNCDHbA1cTest, encodeNCDHealthEducation, encodeNCDHealthEducationSign, encodeNCDHealthEducationValue, encodeNCDLabsResults, encodeNCDLipidPanelTest, encodeNCDLiverFunctionTest, encodeNCDMeasurement, encodeNCDMedicationDistribution, encodeNCDMedicationDistributionValue, encodeNCDMedicationHistory, encodeNCDMedicationHistoryValue, encodeNCDOutsideCare, encodeNCDPainSymptom, encodeNCDPregnancyTest, encodeNCDRandomBloodSugarTest, encodeNCDReferral, encodeNCDSocialHistory, encodeNCDSocialHistorySign, encodeNCDSocialHistoryValue, encodeNCDSymptomReview, encodeNCDSymptomReviewValue, encodeNCDUrineDipstickTest, encodeNCDVitals, encodeNeckCPESign, encodeNextVisitValue, encodeNitriteValue, encodeNonReferralSign, encodeNutrition, encodeNutritionAssessment, encodeNutritionCaring, encodeNutritionCaringOption, encodeNutritionCaringSign, encodeNutritionCaringValueWithType, encodeNutritionContributingFactors, encodeNutritionFeeding, encodeNutritionFeedingSign, encodeNutritionFeedingValueWithType, encodeNutritionFollowUp, encodeNutritionFollowUpValueWithType, encodeNutritionFoodSecurity, encodeNutritionFoodSecuritySign, encodeNutritionFoodSecurityValueWithType, encodeNutritionHealthEducation, encodeNutritionHeight, encodeNutritionHygiene, encodeNutritionHygieneSign, encodeNutritionHygieneValueWithType, encodeNutritionMeasurement, encodeNutritionMuac, encodeNutritionNCDA, encodeNutritionNutrition, encodeNutritionPhoto, encodeNutritionSendToHC, encodeNutritionSign, encodeNutritionSupplementType, encodeNutritionValueWithType, encodeNutritionWeight, encodeObstetricHistory, encodeObstetricHistorySign, encodeObstetricHistoryStep2, encodeObstetricHistoryStep2Sign, encodeObstetricHistoryStep2Value, encodeObstetricHistoryValue, encodeObstetricalExam, encodeObstetricalExamValue, encodeOccursInFamilySign, encodeOutsideCareMedication, encodeOutsideCareSign, encodeOutsideCareValue, encodePHValue, encodeParticipantConsent, encodeParticipantConsentValue, encodePartnerHIVTestValue, encodePhaseRecorded, encodePhoto, encodePostpartumChildDangerSign, encodePostpartumHealingProblem, encodePostpartumMotherDangerSign, encodePredecessor, encodePregnancySummarySign, encodePregnancySummaryValue, encodePregnancyTest, encodePregnancyTestResult, encodePregnancyTestValue, encodePrenatalAspirin, encodePrenatalAspirinValue, encodePrenatalAssesment, encodePrenatalBloodGpRsTest, encodePrenatalBreastfeeding, encodePrenatalCalcium, encodePrenatalCalciumValue, encodePrenatalFamilyPlanning, encodePrenatalFefol, encodePrenatalFefolValue, encodePrenatalFlankPainSign, encodePrenatalFolate, encodePrenatalFolateValue, encodePrenatalFollowUp, encodePrenatalFollowUpValue, encodePrenatalGUExam, encodePrenatalHIVPCRTest, encodePrenatalHIVSign, encodePrenatalHIVTest, encodePrenatalHealthEducation, encodePrenatalHealthEducationSign, encodePrenatalHealthEducationValue, encodePrenatalHemoglobinTest, encodePrenatalHepatitisBTest, encodePrenatalIron, encodePrenatalIronValue, encodePrenatalLabsResults, encodePrenatalMMS, encodePrenatalMMSValue, encodePrenatalMalariaTest, encodePrenatalMeasurement, encodePrenatalMebendazole, encodePrenatalMebendazoleValue, encodePrenatalMedicationDistribution, encodePrenatalMedicationDistributionValue, encodePrenatalMedicationValue, encodePrenatalMentalHealth, encodePrenatalMentalHealthValue, encodePrenatalNutrition, encodePrenatalNutritionValue, encodePrenatalOutsideCare, encodePrenatalPartnerHIVTest, encodePrenatalPhoto, encodePrenatalRandomBloodSugarTest, encodePrenatalReferralValue, encodePrenatalSendToHC, encodePrenatalSpecialityCare, encodePrenatalSymptom, encodePrenatalSymptomQuestion, encodePrenatalSymptomReview, encodePrenatalSymptomReviewValue, encodePrenatalSyphilisTest, encodePrenatalTetanusImmunisation, encodePrenatalUrineDipstickTest, encodePreviousDeliveryPeriod, encodePreviousDeliverySign, encodeProteinValue, encodeRandomBloodSugarTestValue, encodeRapidTestResult, encodeReasonForNonReferral, encodeReasonForNotIsolating, encodeReasonForNotProvidingHealthEducation, encodeReasonForNotTakingSign, encodeReceiveOption, encodeRecommendation114, encodeRecommendationSite, encodeRecommendedTreatmentSign, encodeReferToFacilitySign, encodeReferralFacility, encodeReferralValue, encodeReinforceTreatmentSign, encodeResponsePeriod, encodeRhesus, encodeSendToHC, encodeSendToHCSign, encodeSendToHCValueWithType, encodeSocialHistory, encodeSocialHistorySign, encodeSocialHistoryValue, encodeSpecialityCareSign, encodeSpecialityCareValue, encodeStuntingLevel, encodeSymptomsGI, encodeSymptomsGIDerivedSigns, encodeSymptomsGISign, encodeSymptomsGIValue, encodeSymptomsGeneral, encodeSymptomsGeneralSign, encodeSymptomsGeneralValue, encodeSymptomsRespiratory, encodeSymptomsRespiratorySign, encodeSymptomsRespiratoryValue, encodeSyphilisTestValue, encodeTestExecutionNote, encodeTestPrerequisite, encodeTestResult, encodeTestVariant, encodeTraceOutcome, encodeTravelHistory, encodeTravelHistorySign, encodeTravelHistoryValue, encodeTreatmentOngoing, encodeTreatmentOngoingSign, encodeTreatmentOngoingValueWithType, encodeTreatmentReview, encodeTreatmentReviewSign, encodeTreatmentReviewValue, encodeTuberculosisDOT, encodeTuberculosisDOTSign, encodeTuberculosisDOTValue, encodeTuberculosisDiagnosis, encodeTuberculosisDiagnostics, encodeTuberculosisDiagnosticsValue, encodeTuberculosisFollowUp, encodeTuberculosisHealthEducation, encodeTuberculosisHealthEducationSign, encodeTuberculosisHealthEducationValue, encodeTuberculosisMeasurement, encodeTuberculosisMedication, encodeTuberculosisMedicationValue, encodeTuberculosisPrescribedMedication, encodeTuberculosisReferral, encodeTuberculosisSymptom, encodeTuberculosisSymptomReview, encodeTuberculosisSymptomReviewValue, encodeTuberculosisTreatmentReview, encodeUnitOfMeasurement, encodeUrineDipstickTestValue, encodeUrobilinogenValue, encodeVaccinationDose, encodeVaccinationValueWithType, encodeVaginalExamSign, encodeViralLoadStatus, encodeVitals, encodeVitalsValueWithType, encodeWaterPreparationOption, encodeWeight, encodeWeightInKg, encodeWeightValueWithType, encodeWellChilSymptomsReviewValue, encodeWellChildAlbendazole, encodeWellChildAlbendazoleValue, encodeWellChildBCGImmunisation, encodeWellChildCaring, encodeWellChildContributingFactors, encodeWellChildDTPImmunisation, encodeWellChildDTPStandaloneImmunisation, encodeWellChildECD, encodeWellChildECDValue, encodeWellChildFeeding, encodeWellChildFollowUp, encodeWellChildFoodSecurity, encodeWellChildHPVImmunisation, encodeWellChildHeadCircumference, encodeWellChildHealthEducation, encodeWellChildHeight, encodeWellChildHygiene, encodeWellChildIPVImmunisation, encodeWellChildMRImmunisation, encodeWellChildMeasurement, encodeWellChildMebendezole, encodeWellChildMebendezoleValue, encodeWellChildMuac, encodeWellChildNCDA, encodeWellChildNextVisit, encodeWellChildNutrition, encodeWellChildOPVImmunisation, encodeWellChildPCV13Immunisation, encodeWellChildPhoto, encodeWellChildPregnancySummary, encodeWellChildRotarixImmunisation, encodeWellChildSendToHC, encodeWellChildSymptom, encodeWellChildSymptomsReview, encodeWellChildVitals, encodeWellChildVitaminA, encodeWellChildVitaminAValue, encodeWellChildWeight, malariaRapidTestResultAsString)
