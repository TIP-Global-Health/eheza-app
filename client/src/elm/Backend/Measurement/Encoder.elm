...
encodeNCDSocialHistoryValue value =
    ...
    , ( "type", string "ncd_social_history" )
        ...
        ++ encodeNullable "beverages_per_week" value.beveragesPerWeek int
