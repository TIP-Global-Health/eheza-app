...
{-| Resolve a MUAC measurement to the value shown to the user. MUAC is stored
in cm; at the Burundi site it is displayed in mm, so multiply by 10 there.
Use this anywhere a MUAC value is rendered with a site-dependent unit label.
-}
