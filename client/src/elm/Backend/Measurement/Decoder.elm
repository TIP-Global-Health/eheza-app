module Backend.Measurement.Decoder exposing (decodeAbdomenCPESign, decodeAcuteFindings, decodeAcuteFindingsGeneralSign, decodeAcuteFindingsRespiratorySign, decodeAcuteIllnessContactsTracing, decodeAcuteIllnessCoreExam, decodeAcuteIllnessCoreExamValue, decodeAcuteIllnessDangerSign, decodeAcuteIllnessDangerSigns, decodeAcuteIllnessFollowUp, decodeAcuteIllnessFollowUpValue, decodeAcuteIllnessMeasurement, decodeAcuteIllnessMeasurements, decodeAcuteIllnessMuac, decodeAcuteIllnessNutrition, decodeAcuteIllnessTraceContact, decodeAcuteIllnessVitals, decodeAdministrationNote, decodeAdministrationNoteField, decodeAdverseEvent, decodeAppointmentConfirmation, decodeAttendance, decodeAvoidingGuidanceReason, decodeBilirubinValue, decodeBirthDefect, decodeBirthPlan, decodeBirthPlanSign, decodeBirthPlanValue, decodeBloodGpRsTestValue, decodeBloodGroup, decodeBloodSmearResult, decodeBreastExam, decodeBreastExamSign, decodeBreastfeedingSign, decodeBreastfeedingValue, decodeCSectionReason, decodeCSectionScar, decodeCall114, decodeCall114Sign, decodeChildMeasurementList, decodeChildNutritionSign, decodeChildScoreboardBCGImmunisation, decodeChildScoreboardDTPImmunisation, decodeChildScoreboardDTPStandaloneImmunisation, decodeChildScoreboardIPVImmunisation, decodeChildScoreboardMRImmunisation, decodeChildScoreboardMeasurement, decodeChildScoreboardMeasurements, decodeChildScoreboardNCDA, decodeChildScoreboardOPVImmunisation, decodeChildScoreboardPCV13Immunisation, decodeChildScoreboardRotarixImmunisation, decodeContactTraceItem, decodeContactTraceItemFromString, decodeContributingFactors, decodeContributingFactorsSign, decodeContributingFactorsValue, decodeCorePhysicalExam, decodeCorePhysicalExamValue, decodeCounselingSession, decodeCovidTesting, decodeCovidTestingValue, decodeCreatinineTestValue, decodeDangerSign, decodeDangerSigns, decodeDeliveryComplication, decodeDischargeType, decodeDistributionNotice, decodeECDSign, decodeExposure, decodeExposureSign, decodeEyesCPESign, decodeFamilyPlanning, decodeFamilyPlanningSign, decodeFbf, decodeFbfValue, decodeFetalPresentation, decodeFollowUp, decodeFollowUpMeasurements, decodeFollowUpOption, decodeFollowUpValue, decodeFoodGroup, decodeGUExamSign, decodeGUExamValue, decodeGlucoseValue, decodeGroupHealthEducation, decodeGroupMeasurement, decodeGroupNCDA, decodeGroupSendToHC, decodeHCContact, decodeHCContactSign, decodeHCRecommendation, decodeHIVDiagnosisSign, decodeHIVDiagnostics, decodeHIVDiagnosticsValue, decodeHIVFollowUp, decodeHIVHealthEducation, decodeHIVHealthEducationSign, decodeHIVHealthEducationValue, decodeHIVMeasurement, decodeHIVMeasurements, decodeHIVMedication, decodeHIVMedicationValue, decodeHIVPCRTestValue, decodeHIVPrescribedMedication, decodeHIVReferral, decodeHIVSymptom, decodeHIVSymptomReview, decodeHIVSymptomReviewValue, decodeHIVTestValue, decodeHIVTreatmentReview, decodeHIVTreatmentSign, decodeHaemoglobinValue, decodeHairHeadCPESign, decodeHandsCPESign, decodeHbA1cTestValue, decodeHead, decodeHeadCircumferenceValue, decodeHealthEducation, decodeHealthEducationSign, decodeHealthEducationValue, decodeHeartCPESign, decodeHeight, decodeHemoglobinTestValue, decodeHepatitisBTestValue, decodeHomeVisitMeasurement, decodeHomeVisitMeasurements, decodeIllnessSymptom, decodeIsolation, decodeIsolationSign, decodeKetoneValue, decodeLaboratoryTest, decodeLabsResultsReviewState, decodeLabsResultsValue, decodeLactation, decodeLactationSign, decodeLastMenstrualPeriod, decodeLateFirstANCVisitReason, decodeLegsCPESign, decodeLeukocytesValue, decodeLipidPanelTestValue, decodeLiverFunctionTestValue, decodeLmpDateNotConfidentReason, decodeLungsCPESign, decodeMainIncomeSource, decodeMainWaterSource, decodeMalariaPrevention, decodeMalariaPreventionSign, decodeMalariaPreventionValue, decodeMalariaTestValue, decodeMalariaTesting, decodeMeasurement, decodeMeasurementNote, decodeMedicalCondition, decodeMedicalHistory, decodeMedicalHistoryInfectiousDisease, decodeMedicalHistoryMentalHealthIssue, decodeMedicalHistoryPhysicalCondition, decodeMedicalHistorySign, decodeMedicalHistoryValue, decodeMedication, decodeMedicationCausingHypertension, decodeMedicationDistribution, decodeMedicationDistributionSign, decodeMedicationDistributionValue, decodeMedicationNonAdministrationSign, decodeMedicationSign, decodeMedicationTreatingDiabetes, decodeMedicationTreatingHypertension, decodeMedicationTreatmentSign, decodeMedicationValue, decodeMotherMeasurementList, decodeMuac, decodeNCDASign, decodeNCDAValue, decodeNCDCoMorbidities, decodeNCDCoMorbiditiesValue, decodeNCDCoreExam, decodeNCDCreatinineTest, decodeNCDDangerSign, decodeNCDDangerSigns, decodeNCDDangerSignsValue, decodeNCDFamilyHistory, decodeNCDFamilyHistorySign, decodeNCDFamilyHistoryValue, decodeNCDFamilyPlanning, decodeNCDGroup1Symptom, decodeNCDGroup2Symptom, decodeNCDGuidanceSign, decodeNCDHIVTest, decodeNCDHbA1cTest, decodeNCDHealthEducation, decodeNCDHealthEducationSign, decodeNCDHealthEducationValue, decodeNCDLabsResults, decodeNCDLipidPanelTest, decodeNCDLiverFunctionTest, decodeNCDMeasurement, decodeNCDMeasurements, decodeNCDMedicationDistribution, decodeNCDMedicationDistributionValue, decodeNCDMedicationHistory, decodeNCDMedicationHistoryValue, decodeNCDOutsideCare, decodeNCDPainSymptom, decodeNCDPregnancyTest, decodeNCDRandomBloodSugarTest, decodeNCDReferral, decodeNCDSocialHistory, decodeNCDSocialHistorySign, decodeNCDSocialHistoryValue, decodeNCDSymptomReview, decodeNCDSymptomReviewValue, decodeNCDUrineDipstickTest, decodeNCDVitals, decodeNeckCPESign, decodeNextVisitValue, decodeNitriteValue, decodeNonReferralSign, decodeNutrition, decodeNutritionAssessment, decodeNutritionAssessmentFromString, decodeNutritionCaring, decodeNutritionCaringOption, decodeNutritionCaringSign, decodeNutritionCaringValue, decodeNutritionContributingFactors, decodeNutritionFeeding, decodeNutritionFeedingSign, decodeNutritionFeedingValue, decodeNutritionFollowUp, decodeNutritionFollowUpValue, decodeNutritionFoodSecurity, decodeNutritionFoodSecuritySign, decodeNutritionFoodSecurityValue, decodeNutritionHealthEducation, decodeNutritionHeight, decodeNutritionHygiene, decodeNutritionHygieneSign, decodeNutritionHygieneValue, decodeNutritionMeasurement, decodeNutritionMeasurements, decodeNutritionMuac, decodeNutritionNCDA, decodeNutritionNutrition, decodeNutritionPhoto, decodeNutritionSendToHC, decodeNutritionSupplementType, decodeNutritionValue, decodeNutritionWeight, decodeObstetricHistory, decodeObstetricHistorySign, decodeObstetricHistoryStep2, decodeObstetricHistoryStep2Sign, decodeObstetricalExam, decodeOccursInFamilySign, decodeOutsideCareMedication, decodeOutsideCareSign, decodeOutsideCareValue, decodePHValue, decodeParticipantConsent, decodeParticipantConsentValue, decodePartnerHIVTestValue, decodePhaseRecorded, decodePhoto, decodePostpartumChildDangerSign, decodePostpartumHealingProblem, decodePostpartumMotherDangerSign, decodePredecessor, decodePregnancyByNewborn, decodePregnancySummarySign, decodePregnancySummaryValue, decodePregnancyTest, decodePregnancyTestResult, decodePregnancyTestValue, decodePrenatalAspirin, decodePrenatalAssesment, decodePrenatalBloodGpRsTest, decodePrenatalBreastfeeding, decodePrenatalCalcium, decodePrenatalFamilyPlanning, decodePrenatalFefol, decodePrenatalFlankPainSign, decodePrenatalFolate, decodePrenatalFollowUp, decodePrenatalFollowUpValue, decodePrenatalGUExam, decodePrenatalHIVPCRTest, decodePrenatalHIVSign, decodePrenatalHIVTest, decodePrenatalHealthEducation, decodePrenatalHealthEducationSign, decodePrenatalHealthEducationValue, decodePrenatalHemoglobinTest, decodePrenatalHepatitisBTest, decodePrenatalIron, decodePrenatalLabsResults, decodePrenatalMMS, decodePrenatalMalariaTest, decodePrenatalMeasurement, decodePrenatalMeasurements, decodePrenatalMebendazole, decodePrenatalMedicationDistribution, decodePrenatalMedicationDistributionValue, decodePrenatalMentalHealth, decodePrenatalMentalHealthQuestion, decodePrenatalMentalHealthQuestionOption, decodePrenatalMentalHealthQuestionTuple, decodePrenatalMentalHealthValue, decodePrenatalNutrition, decodePrenatalOutsideCare, decodePrenatalPartnerHIVTest, decodePrenatalPhoto, decodePrenatalRandomBloodSugarTest, decodePrenatalReferralValue, decodePrenatalSendToHc, decodePrenatalSpecialityCare, decodePrenatalSymptom, decodePrenatalSymptomQuestion, decodePrenatalSymptomReview, decodePrenatalSymptomReviewValue, decodePrenatalSyphilisTest, decodePrenatalTetanusImmunisation, decodePrenatalUrineDipstickTest, decodePreviousDeliveryPeriod, decodePreviousDeliverySign, decodeProteinValue, decodeRandomBloodSugarTestValue, decodeRapidTestResult, decodeReasonForNonReferral, decodeReasonForNotIsolating, decodeReasonForNotProvidingHealthEducation, decodeReasonForNotTaking, decodeReceiveOption, decodeRecommendation114, decodeRecommendationSite, decodeRecommendedTreatmentSign, decodeReferToFacilitySign, decodeReferralFacility, decodeReferralValue, decodeReinforceTreatmentSign, decodeResponsePeriod, decodeRhesus, decodeSendToHC, decodeSendToHCSign, decodeSendToHCValue, decodeSocialHistory, decodeSocialHistorySign, decodeSpecialityCareSign, decodeSpecialityCareValue, decodeStockManagementMeasurements, decodeStuntingLevel, decodeSymptomsGI, decodeSymptomsGIDerivedSign, decodeSymptomsGIDict, decodeSymptomsGISign, decodeSymptomsGeneral, decodeSymptomsGeneralSign, decodeSymptomsRespiratory, decodeSymptomsRespiratorySign, decodeSyphilisTestValue, decodeTestExecutionNote, decodeTestPrerequisite, decodeTestResult, decodeTestVariant, decodeTraceOutcome, decodeTravelHistory, decodeTravelHistorySign, decodeTreatmentOngoing, decodeTreatmentOngoingSign, decodeTreatmentOngoingValue, decodeTreatmentReview, decodeTreatmentReviewSign, decodeTuberculosisDOT, decodeTuberculosisDOTSign, decodeTuberculosisDOTValue, decodeTuberculosisDiagnosis, decodeTuberculosisDiagnostics, decodeTuberculosisDiagnosticsValue, decodeTuberculosisFollowUp, decodeTuberculosisHealthEducation, decodeTuberculosisHealthEducationSign, decodeTuberculosisHealthEducationValue, decodeTuberculosisMeasurement, decodeTuberculosisMeasurements, decodeTuberculosisMedication, decodeTuberculosisMedicationValue, decodeTuberculosisPrescribedMedication, decodeTuberculosisReferral, decodeTuberculosisSymptom, decodeTuberculosisSymptomReview, decodeTuberculosisSymptomReviewValue, decodeTuberculosisTreatmentReview, decodeUnitOfMeasurement, decodeUrineDipstickTestValue, decodeUrobilinogenValue, decodeVaccinationValue, decodeVaccineDose, decodeVaginalExamSign, decodeViralLoadStatus, decodeVitals, decodeVitalsValue, decodeWaterPreparationOption, decodeWeight, decodeWellChildAlbendazole, decodeWellChildBCGImmunisation, decodeWellChildCaring, decodeWellChildContributingFactors, decodeWellChildDTPImmunisation, decodeWellChildDTPStandaloneImmunisation, decodeWellChildECD, decodeWellChildFeeding, decodeWellChildFollowUp, decodeWellChildFoodSecurity, decodeWellChildHPVImmunisation, decodeWellChildHeadCircumference, decodeWellChildHealthEducation, decodeWellChildHeight, decodeWellChildHygiene, decodeWellChildIPVImmunisation, decodeWellChildMRImmunisation, decodeWellChildMeasurement, decodeWellChildMeasurements, decodeWellChildMebendezole, decodeWellChildMuac, decodeWellChildNCDA, decodeWellChildNextVisit, decodeWellChildNutrition, decodeWellChildOPVImmunisation, decodeWellChildPCV13Immunisation, decodeWellChildPhoto, decodeWellChildPregnancySummary, decodeWellChildRotarixImmunisation, decodeWellChildSendToHC, decodeWellChildSymptom, decodeWellChildSymptomsReview, decodeWellChildVitals, decodeWellChildVitaminA, decodeWellChildWeight, decodeWithEntityUuid, malariaRapidTestResultFromString, postProcessNutritionAssessment, prerequisitesDefaultNonRDT, prerequisitesDefaultRDT, symptomsGIToDict, symptomsGeneralToDict, symptomsRespiratoryToDict)
