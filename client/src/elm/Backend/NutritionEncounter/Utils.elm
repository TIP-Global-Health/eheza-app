module Backend.NutritionEncounter.Utils exposing (calculateZScoreWeightForAge, generateIndividualChildScoreboardMeasurementsForChild, generateIndividualNutritionMeasurementsForChild, generateIndividualWellChildMeasurementsForChild, generateNutritionAssessment, generateNutritionAssessmentByWeight, getAcuteIllnessEncountersForParticipant, getChildScoreboardEncountersForParticipant, getHIVEncountersForParticipant, getHomeVisitEncountersForParticipant, getNCDEncountersForParticipant, getNewbornExamPregnancySummary, getNutritionEncountersForParticipant, getParticipantEncountersByEncounterType, getPrenatalEncountersForParticipant, getTuberculosisEncountersForParticipant, getWellChildEncountersForParticipant, muacModerate, muacSevere, nutritionAssessmentForBackend, resolveAllWeightMeasurementsForChild, resolveIndividualChildScoreboardValues, resolveIndividualNutritionValues, resolveIndividualWellChildValues, resolveNCDANeverFilled, resolveNCDANotFilledAfterAgeOfSixMonths, resolveNCDAValuesForChild, resolveNutritionWeightMeasurementsForChild, resolvePreviousMeasurementsSetForChild, resolvePreviousNCDAValuesForChild, resolvePreviousValuesSetForChild, resolveWellChildWeightMeasurementsForChild, zScoreWeightForAgeModerate, zScoreWeightForAgeSevere)
