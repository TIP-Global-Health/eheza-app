...
import Backend.Utils exposing (stockManagementChwEnabled, stockManagementEnabled)
            ...
            activities =
                if isLabTech then
                    ...
                    , MenuDeviceStatus
                        ...
                        ++ (if
                                (not isChw && stockManagementEnabled features)
                                    || (isChw && stockManagementChwEnabled features)
                            then
                                [ MenuStockManagement ]
