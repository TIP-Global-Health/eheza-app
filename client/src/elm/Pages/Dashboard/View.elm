...
viewChildWellnessOverviewPage language site dateLastDayOfSelectedMonth rawSPVDataItems childScoreboardDataItem =
    let
        spvDataItems =
            spvDataMergeDuplicates rawSPVDataItems
