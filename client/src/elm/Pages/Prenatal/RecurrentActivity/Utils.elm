module Pages.Prenatal.RecurrentActivity.Utils exposing (activityCompleted, diagnosisRequiresEmergencyReferal, examinationMeasurementTaken, examinationTasksCompletedFromTotal, expectActivity, healthEducationFormInputsAndTasks, healthEducationFormWithDefault, laboratoryResultTaskCompleted, nextStepsTaskCompleted, nextStepsTasksCompletedFromTotal, resolveLaboratoryResultTask, resolveNextStepsTasks, resolveReferralInputsAndTasks, toHealthEducationValueWithDefault)
