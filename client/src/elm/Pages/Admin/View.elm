...
viewCreateSessionForm config language backend model form clinics sessions =
    let
        ...
        clinicOptions =
            ( "", translate language Translate.SelectPMTCTGroup )
        ...
        requestStatus =
            case backend.postSessionRequest of
                Success _ ->
                    ...
                    if Set.isEmpty (Form.getChangedFields form) then
                        div
                            ...
                            , div [] [ text <| translate language Translate.YourPMTCTGroupEncounterHasBeenSaved ]
                            ]
                ...
                NotAsked ->
                    emptyNode
    in
    [ h2 [] [ text <| translate language Translate.CreatePMTCTGroupEncounter ]
    , div
        ...
        [ div
            ...
            [ label [] [ text <| translate language Translate.PMTCTGroup ]
...
viewFormError language ( path, error ) =
    if path == clinicId then
        ...
        -- customaized message
        li [] [ text <| translate language Translate.PleaseSelectPMTCTGroup ]
            ...
            if config.sandbox then
                div []
                    [ button
                        ...
                        [ text <| translate language <| Translate.CreateTrainingPMTCTGroupEncounters ]
                    , text " "
                    , button
                        [ class "ui primary button small"
                        , Confirmation.Open
                            { title = translate language Translate.ConfirmDeleteTrainingPMTCTGroupEncounters
                        ...
                        [ text <| translate language <| Translate.DeleteTrainingPMTCTGroupEncounters
                        ]
        ...
        buttons =
            div []
                [ button
                    ...
                    [ text <| translate language <| Translate.CreatePMTCTGroupEncounter ]
                , sandboxButtons
                ]
                ...
                Success { action } ->
                    let
                        ( messageClass, messageType, message ) =
                            case action of
                                CreateAll ->
                                    ( "success", Translate.Success, Translate.TrainingPMTCTGroupEncounterCreateSuccessMessage )

                                DeleteAll ->
                                    ( "success", Translate.Success, Translate.TrainingPMTCTGroupEncounterDeleteSuccessMessage )
                    in
                    div
