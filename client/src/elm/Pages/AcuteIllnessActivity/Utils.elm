...
fromMedicationDistributionValue saved =
    ...
    , nonAdministrationReasons = Maybe.map .nonAdministrationSigns saved
    }
    ...
    saved
        |> unwrap
            ...
            (\value ->
                ...
                , nonAdministrationReasons = or form.nonAdministrationReasons (Just value.nonAdministrationSigns)
                }
            )
