module Pages.NCD.Activity.Utils exposing (activityCompleted, coMorbiditiesFormInputsAndTasks, coMorbiditiesFormWithDefault, dangerSignsFormWithDefault, examinationTasksCompletedFromTotal, expectActivity, expectLaboratoryTask, expectNextStepsTask, familyHistoryFormInputsAndTasks, familyHistoryFormWithDefault, generatePreviousLaboratoryTestsDatesDict, generateVitalsFormConfig, healthEducationFormInputsAndTasks, healthEducationFormWithDefault, laboratoryTaskCompleted, laboratoryTasks, mandatoryActivitiesForNextStepsCompleted, medicalHistoryTasksCompletedFromTotal, medicationHistoryFormInputsAndTasks, medicationHistoryFormWithDefault, nextStepsTaskCompleted, nextStepsTasksCompletedFromTotal, outsideCareDiagnosesLeftColumn, outsideCareDiagnosesRightColumn, resolveNextStepsTasks, resolvePreviousMaybeValue, resolvePreviousValue, socialHistoryFormInputsAndTasks, socialHistoryFormWithDefault, symptomReviewFormWithDefault, toCoMorbiditiesValue, toCoMorbiditiesValueWithDefault, toDangerSignsValue, toDangerSignsValueWithDefault, toFamilyHistoryValue, toFamilyHistoryValueWithDefault, toHealthEducationValue, toHealthEducationValueWithDefault, toMedicationHistoryValue, toMedicationHistoryValueWithDefault, toSocialHistoryValue, toSocialHistoryValueWithDefault, toSymptomReviewValue, toSymptomReviewValueWithDefault)
