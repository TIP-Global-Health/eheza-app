module Pages.WellChild.Activity.Utils exposing (activityCompleted, ageInMonthsAtLastAssessment, albendazoleAdministrationFormConfig, dangerSignsTasksCompletedFromTotal, ecdSigns6To12MonthsMajors, ecdSigns6To12MonthsMinors, ecdSignsFrom13Weeks, ecdSignsFrom15Months, ecdSignsFrom18Months, ecdSignsFrom2Years, ecdSignsFrom3Years, ecdSignsFrom4Years, ecdSignsFrom5Weeks, ecdSignsFromGroupedSignsByAge, expectActivity, expectImmunisationTask, expectMedicationByAge, expectMedicationTask, expectNextStepsTask, expectNutritionAssessmentTask, expectedECDSignsByAge, expectedECDSignsOnMilestone, fromHeadCircumferenceValue, fromNextVisitValue, fromPregnancySummaryValue, fromSymptomsReviewValue, generateASAPImmunisationDate, generateCompletedECDSigns, generateNextDateForECDVisit, generateNextDateForImmunisationVisit, generateNextDateForMedicationVisit, generateNextVisitDates, generateNutritionAssessment, generateRemianingECDSigns, generateRemianingECDSignsAfterCurrentEncounter, generateRemianingECDSignsBeforeCurrentEncounter, generateVaccinationProgress, generateVitalsFormConfig, getFormByVaccineTypeFunc, getMeasurementByVaccineTypeFunc, groupedECDSigns, headCircumferenceFormAndTasks, headCircumferenceFormWithDefault, immunisationTaskCompleted, immunisationTasks, immunisationTasksCompletedFromTotal, immunisationVaccinationTasks, latestAdministrationDateForMedicine, listNotEmptyWithException, mandatoryNutritionAssessmentTasksCompleted, mebendezoleAdministrationFormConfig, medicationTaskCompleted, medicationTasksCompletedFromTotal, nextMedicationAdmnistrationData, nextStepsTaskCompleted, nextStepsTasks, nextStepsTasksCompletedFromTotal, nextVisitFormWithDefault, nextVisitRequired, nutritionAssessmentTaskCompleted, nutritionAssessmentTasksCompletedFromTotal, pregnancySummaryFormWithDefault, resolveAlbendazoleDosageAndIcon, resolveMandatoryNutritionAssessmentTasks, resolveMebendezoleDosageAndIcon, resolveNutritionAssessmentTasks, resolvePreviousValue, resolveVitaminADosageAndIcon, symptomsReviewFormInputsAndTasks, symptomsReviewFormWithDefault, toHeadCircumferenceValue, toHeadCircumferenceValueWithDefault, toNextVisitValue, toNextVisitValueWithDefault, toPregnancySummaryValue, toPregnancySummaryValueWithDefault, toSymptomsReviewValue, toSymptomsReviewValueWithDefault, toWellChildECDValue, toWellChildECDValueWithDefault, updateVaccinationFormByVaccineType, vaccinationFormDynamicContentAndTasks, vitaminAAdministrationFormConfig, wellChildECDFormWithDefault)
