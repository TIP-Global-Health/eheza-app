module Pages.HealthyStart.Utils exposing (..)
...
import Pages.HealthyStart.Types exposing (..)
import Pages.Utils
    exposing
...
diagnosesCausingHospitalReferralByPhase : HealthyStartEncounterPhase -> AssembledData -> EverySet PrenatalDiagnosis
diagnosesCausingHospitalReferralByPhase phase assembled =
    applyDiagnosesHierarchy <|
        case phase of
            HealthyStartEncounterPhaseInitial ->
                let
                    byImmediateDiagnoses =
                        diagnosesCausingHospitalReferralByImmediateDiagnoses HealthyStartEncounterPhaseInitial assembled
                in
                        ...
                        let
                            general =
                                byImmediateDiagnoses
                                    ...
                                    ++ diagnosesCausingHospitalReferralByOtherReasons HealthyStartEncounterPhaseInitial assembled
            ...
            HealthyStartEncounterPhaseRecurrent ->
                diagnosesCausingHospitalReferralByImmediateDiagnoses HealthyStartEncounterPhaseRecurrent assembled
                    ++ diagnosesCausingHospitalReferralByOtherReasons HealthyStartEncounterPhaseRecurrent assembled
                    |> EverySet.fromList
...
diagnosesCausingHospitalReferralByOtherReasons : HealthyStartEncounterPhase -> AssembledData -> List PrenatalDiagnosis
...
diagnosesCausingHospitalReferralByImmediateDiagnoses : HealthyStartEncounterPhase -> AssembledData -> List PrenatalDiagnosis
                ...
                HealthyStartEncounterPhaseInitial ->
                    emergencyReferralDiagnosesInitial
                        ++ [ DiagnosisModeratePreeclampsiaInitialPhase
                           ...
                           , DiagnosisModeratePreeclampsiaInitialPhase
                           , DiagnosisSeverePreeclampsiaInitialPhase
                           , Backend.HealthyStartEncounter.Types.DiagnosisDiabetesInitialPhase
                           , Backend.HealthyStartEncounter.Types.DiagnosisGestationalDiabetesInitialPhase
                ...
                HealthyStartEncounterPhaseRecurrent ->
                    emergencyReferralDiagnosesRecurrent
                        ++ [ DiagnosisHepatitisBRecurrentPhase
                           ...
                           , Backend.HealthyStartEncounter.Types.DiagnosisDiabetesRecurrentPhase
                           , Backend.HealthyStartEncounter.Types.DiagnosisGestationalDiabetesRecurrentPhase
...
medicationDistributionFormWithDefault : MedicationDistributionSign -> MedicationDistributionForm -> Maybe HealthyStartMedicationDistributionValue -> MedicationDistributionForm
...
medicationDistributionFormWithDefaultInitialPhase : MedicationDistributionForm -> Maybe HealthyStartMedicationDistributionValue -> MedicationDistributionForm
medicationDistributionFormWithDefaultInitialPhase form saved =
    saved
        |> unwrap
            form
...
medicationDistributionFormWithDefaultRecurrentPhase : MedicationDistributionForm -> Maybe HealthyStartMedicationDistributionValue -> MedicationDistributionForm
medicationDistributionFormWithDefaultRecurrentPhase form saved =
    saved
        |> unwrap
            form
...
medicationDistributionResolveFromValue :
    ...
    -> HealthyStartMedicationDistributionValue
...
toMedicationDistributionValueWithDefaultInitialPhase :
    Maybe HealthyStartMedicationDistributionValue
...
-}
medicationDistributionMeasurementTaken : List MedicationDistributionSign -> HealthyStartMeasurements -> Bool
...
patientReportedNoMedicineRecievedFromPMTCT : HealthyStartMeasurements -> Bool
...
resolveMedicationDistributionInputsAndTasksForMedication language currentDate person setMedicationDistributionBoolInputMsg setMedicationDistributionAdministrationNoteMsg form medication =
    case medication of
        ...
        -- Other medications are not prescribed at HealthyStart encounter.
        _ ->
            ( [], 0, 0 )
                ...
                |> Maybe.map
                    (\( dosage, icon ) ->
                        div [ class "instructions" ]
                            ...
                            , div [ class "prescription" ] [ text <| translate language Translate.AdministerHealthyStartMebendezoleHelper ++ "." ]
                            ]
                    )
                |> Maybe.withDefault emptyNode
                ...
                |> Maybe.map
                    (\( dosage, icon ) ->
                        div [ class "instructions" ]
                            ...
                            , div [ class "prescription" ] [ text <| translate language Translate.AdministerVitaminAHelperHealthyStart ++ "." ]
                            ]
                    )
                |> Maybe.withDefault emptyNode
...
hivProgramAtHC : HealthyStartMeasurements -> Bool
...
of those signs was set.
-}
recommendedTreatmentMeasurementTaken : List RecommendedTreatmentSign -> HealthyStartMeasurements -> Bool
...
reinforceTreatmentSignsCompleted : HealthyStartMeasurements -> Bool
...
diagnosedHypertension : HealthyStartEncounterPhase -> AssembledData -> Bool
...
knownAsHIVPositive : HealthyStartMeasurements -> Bool
...
diagnosedMalariaByPhase : HealthyStartEncounterPhase -> AssembledData -> Bool
...
diagnosedModerateAnemiaByPhase : HealthyStartEncounterPhase -> AssembledData -> Bool
...
diagnosedSyphilisByPhase : HealthyStartEncounterPhase -> AssembledData -> Bool
...
outsideCareDiagnosesLeftColumn =
    ...
    , DiagnosisSevereAnemiaRecurrentPhase
    , DiagnosisPelvicPainIntense
    , Backend.HealthyStartEncounter.Types.DiagnosisTuberculosis
    ]
...
generateVaccinationProgress : List HealthyStartMeasurements -> VaccinationProgressDict
...
referralFormWithDefault : ReferralForm -> Maybe HealthyStartReferralValue -> ReferralForm
    ...
    saved
        |> unwrap
            ...
            (\value ->
                ...
                , accompanyToHealthCenter = or form.accompanyToHealthCenter (resolveFromHCSignsValue HealthyStartAccompanyToHC)
...
toHealthyStartReferralValueWithDefault : Maybe HealthyStartReferralValue -> ReferralForm -> Maybe HealthyStartReferralValue
toHealthyStartReferralValueWithDefault saved form =
    referralFormWithDefault form saved
        |> toHealthyStartReferralValue


toHealthyStartReferralValue : ReferralForm -> Maybe HealthyStartReferralValue
toHealthyStartReferralValue form =
    let
        sendToHCSignsByForm =
            [ ifNullableTrue HandReferrerForm form.handReferralForm
            , ifNullableTrue ReferToHealthCenter form.referToHealthCenter
            , ifNullableTrue HealthyStartAccompanyToHC form.accompanyToHealthCenter
            ]
                |> Maybe.Extra.combine
        ...
        maybeConfig =
            case facility of
                ...
                FacilityMentalHealthSpecialist ->
                    Just
                        { header = [ viewCustomLabel language Translate.HealthyStartMentalHealthSpecialistHelper "." "instructions" ]
                    ...
                    Just
                        { header =
                            ...
                            if forPostpartum then
                                            ...
                                            |> Maybe.map
                                                (\diagnosis ->
                                                    div [ class "label header" ]
                                                        [ text <| translate language Translate.HealthyStartNCDProgramHeaderPrefix
                                                        , text " "
                                                        , text <| translate language <| Translate.PrenatalDiagnosis diagnosis
                                                        , text " "
                                                        , text <| translate language Translate.HealthyStartNCDProgramHeaderSuffix
                                                        , text "."
                                                        ]
                                                )
                                            |> Maybe.withDefault emptyNode
                                in
                                [ header
                                , viewCustomLabel language (Translate.HealthyStartARVProgramInstructions forPostpartum) "." "instructions"
                                ]
                ...
                FacilityNCDProgram ->
                    Just
                        { header =
                            let
                                headerText =
                                    translate language Translate.HealthyStartNCDProgramHeaderPrefix
                                        ++ " "
                                        ++ diagnosesForView
                                        ++ " "
                                        ++ translate language Translate.HealthyStartNCDProgramHeaderSuffix
                                        ++ "."
                            ...
                            , viewCustomLabel language Translate.HealthyStartNCDProgramInstructions "." "instructions"
                            ]
                ...
                FacilityANCServices ->
                    -- Not in use at HealthyStart
                    Nothing

                FacilityUltrasound ->
                    Just
                        { header =
                            [ div [ class "label" ] [ text <| translate language Translate.HealthyStartUltrasoundHeader ++ "." ]
                            , viewCustomLabel language Translate.HealthyStartUltrasoundInstructions "." "instructions"
                            ]
...
provideHIVEducation : HealthyStartEncounterPhase -> HealthyStartMeasurements -> Bool
...
provideHIVPartnerPresenceEducation : HealthyStartMeasurements -> Bool
        ...
        detectableViralLoad triggeringDiagnosis =
            if diagnosed triggeringDiagnosis assembled then
                ( [ viewCustomLabel language Translate.DetectableViralLoad "" "label header"
                  , viewCustomLabel language Translate.HealthyStartHealthEducationHivDetectableViralLoadInform "." "label paragraph"
                  , viewQuestionLabel language Translate.HealthyStartHealthEducationAppropriateProvided
                  , viewBoolInput
                        language
        ...
        diabetes triggeringDiagnoses =
            if diagnosedAnyOf triggeringDiagnoses assembled then
                ...
                ( [ viewCustomLabel language header "" "label header"
                  , viewCustomLabel language Translate.HealthyStartHealthEducationDiabetesInform "." "label paragraph"
                  , viewQuestionLabel language Translate.HealthyStartHealthEducationAppropriateProvided
                  , viewBoolInput
                        language
                        form.diabetes
                    ...
                    let
                        hivPartnerPresenceEducation =
                            if provideHIVPartnerPresenceEducation assembled.measurements then
                                ( [ viewCustomLabel language (Translate.HealthyStartHealthEducationLabel EducationHIVPartnerPresence) "" "label header"
                                  , viewQuestionLabel language (Translate.HealthyStartHealthEducationQuestion False EducationHIVPartnerPresence)
                                  , viewBoolInput
                                        language
                        ...
                        nauseaVomiting =
                            if provideNauseaAndVomitingEducation assembled then
                                ( [ viewCustomLabel language (Translate.HealthyStartHealthEducationLabel EducationNauseaVomiting) "" "label header"
                                  , viewCustomLabel language Translate.HealthyStartHealthEducationNauseaAndVomitingInform "." "label paragraph"
                                  , viewCustomLabel language Translate.HealthyStartHealthEducationNauseaAndVomitingAdvise "." "label paragraph"
                                  , viewQuestionLabel language Translate.HealthyStartHealthEducationAppropriateProvided
                                  , viewBoolInput
                                        language
                                        form.nauseaVomiting
                                ...
                                let
                                    reliefMethods =
                                        List.map
                                            ...
                                            |> ul []
                                in
                                ( [ viewCustomLabel language (Translate.HealthyStartHealthEducationLabel EducationLegCramps) "" "label header"
                                  , viewLabel language Translate.HealthyStartHealthEducationLegCrampsInform
                                  , reliefMethods
                                  , viewQuestionLabel language Translate.HealthyStartHealthEducationAppropriateProvided
                                  , viewBoolInput
                                        language
                        ...
                        lowBackPain =
                            if symptomRecorded assembled.measurements LowBackPain then
                                ( [ viewCustomLabel language (Translate.HealthyStartHealthEducationLabel EducationLowBackPain) "" "label header"
                                  , viewCustomLabel language Translate.HealthyStartHealthEducationLowBackPainInform "." "label paragraph"
                                  , viewQuestionLabel language Translate.HealthyStartHealthEducationAppropriateProvided
                                  , viewBoolInput
                                        language
                                        form.lowBackPain
                        ...
                        constipation =
                            if symptomRecorded assembled.measurements Constipation then
                                ( [ viewCustomLabel language (Translate.HealthyStartHealthEducationLabel EducationConstipation) "" "label header"
                                  , viewCustomLabel language Translate.HealthyStartHealthEducationConstipationInform "." "label paragraph"
                                  , viewQuestionLabel language Translate.HealthyStartHealthEducationAppropriateProvided
                                  , viewBoolInput
                                        language
                                        form.constipation
                                ...
                                let
                                    reliefMethods =
                                        List.map
                                            ...
                                            |> ul []
                                in
                                ( [ viewCustomLabel language (Translate.HealthyStartHealthEducationLabel EducationHeartburn) "" "label header"
                                  , viewLabel language Translate.HealthyStartHealthEducationHeartburnInform
                                  , reliefMethods
                                  , viewQuestionLabel language Translate.HealthyStartHealthEducationAppropriateProvided
                                  , viewBoolInput
                                        language
                        ...
                        varicoseVeins =
                            if symptomRecorded assembled.measurements VaricoseVeins then
                                ( [ viewCustomLabel language (Translate.HealthyStartHealthEducationLabel EducationVaricoseVeins) "" "label header"
                                  , viewCustomLabel language Translate.HealthyStartHealthEducationVaricoseVeinsInform "." "label paragraph"
                                  , viewQuestionLabel language Translate.HealthyStartHealthEducationAppropriateProvided
                                  , viewBoolInput
                                        language
                                        form.varicoseVeins
                        ...
                        legPainRedness =
                            if provideLegPainRednessEducation assembled then
                                ( [ viewCustomLabel language (Translate.HealthyStartHealthEducationLabel EducationLegPainRedness) "" "label header"
                                  , viewCustomLabel language Translate.HealthyStartHealthEducationLegPainRednessInform "." "label paragraph"
                                  , viewQuestionLabel language Translate.HealthyStartHealthEducationAppropriateProvided
                                  , viewBoolInput
                                        language
                                        form.legPainRedness
                        ...
                        pelvicPain =
                            if providePelvicPainEducation assembled then
                                ( [ viewCustomLabel language (Translate.HealthyStartHealthEducationLabel EducationPelvicPain) "" "label header"
                                  , viewCustomLabel language Translate.HealthyStartHealthEducationPelvicPainInform "." "label paragraph"
                                  , viewQuestionLabel language Translate.HealthyStartHealthEducationAppropriateProvided
                                  , viewBoolInput
                                        language
                                        form.pelvicPain
                                ...
                                let
                                    label =
                                        List.filter (symptomRecorded assembled.measurements)
                                            ...
                                            |> List.map (Translate.HealthyStartSymptom >> translate language)
                                            |> String.join ", "
                                in
                                ( [ div [ class "label header" ] [ text label ]
                                  , viewCustomLabel language Translate.HealthyStartHealthEducationSaferSexInform "." "label paragraph"
                                  , viewQuestionLabel language Translate.HealthyStartHealthEducationAppropriateProvided
                                  , viewBoolInput
                                        language
                                        form.saferSex
                        ...
                        mentalHealth =
                            if provideMentalHealthEducation assembled then
                                ( [ viewCustomLabel language (Translate.HealthyStartHealthEducationLabel EducationMentalHealth) "" "label header"
                                  , viewCustomLabel language Translate.HealthyStartHealthEducationMentalHealthInform "." "label paragraph"
                                  , viewQuestionLabel language Translate.HealthyStartHealthEducationAppropriateProvided
                                  , viewBoolInput
                                        language
                                        form.mentalHealth
                        ...
                        hierarchalMastitis =
                            if diagnosedAnyOf [ DiagnosisPostpartumEarlyMastitisOrEngorgment, DiagnosisPostpartumMastitis ] assembled then
                                ...
                                in
                                ( [ viewCustomLabel language (Translate.HealthyStartHealthEducationLabel educationSign) "" "label header"
                                  , viewCustomLabel language Translate.HealthyStartHealthEducationEarlyMastitisOrEngorgmentInform ":" "label paragraph"
                                  , reliefMethods
                                  , viewQuestionLabel language Translate.HealthyStartHealthEducationAppropriateProvided
                                  , viewBoolInput
                                        language
...
healthEducationFormInputsAndTasksForHIV language setBoolInputMsg assembled form =
    let
        translateHealthyStartHealthEducationQuestion =
            Translate.HealthyStartHealthEducationQuestion False
        ...
        saferSexHIVInput =
            [ viewQuestionLabel language <| translateHealthyStartHealthEducationQuestion EducationSaferSexHIV
            , viewBoolInput
                language
                form.saferSexHIV
        ...
        partnerTestingInput =
            [ viewQuestionLabel language <| translateHealthyStartHealthEducationQuestion EducationPartnerTesting
            , viewBoolInput
                language
                form.partnerTesting
    ...
    if diagnosedAnyOf trigerringDiagnoses assembled then
        let
            positiveHIVInput =
                [ viewQuestionLabel language <| translateHealthyStartHealthEducationQuestion EducationPositiveHIV
                , viewBoolInput
                    language
                    form.positiveHIV
...
healthEducationFormFamilyPlanningInput language setBoolInputMsg isChw form =
    ...
    in
    [ viewQuestionLabel language <| Translate.HealthyStartHealthEducationQuestion isChw EducationFamilyPlanning
    , viewBoolInput
        language
        form.familyPlanning
...
symptomRecorded : HealthyStartMeasurements -> HealthyStartSymptom -> Bool
...
symptomRecordedPreviously : AssembledData -> HealthyStartSymptom -> Bool
