module Pages.HealthyStart.Model exposing (..)
...
type alias AssembledData =
    { id : HealthyStartEncounterId
    , encounter : HealthyStartEncounter
    , participant : IndividualEncounterParticipant
    , person : Person
    , measurements : HealthyStartMeasurements
    , nursePreviousEncountersData : List PreviousEncounterData
    , chwPreviousMeasurementsWithDates : List ( NominalDate, HealthyStartEncounterType, HealthyStartMeasurements )
...
type alias VaccinationProgressDict =
    Dict HealthyStartVaccineType (Dict VaccineDose NominalDate)
...
type HealthyStartEncounterPhase
