...
view language currentDate id isChw db model =
    text "PrenatalRecurrentEncounter"
...
-- viewHeaderAndContent : Language -> NominalDate -> PrenatalRecurrentEncounterId -> Bool -> Model -> AssembledData -> Html Msg
...
--         , span
--             [ class "link-back"
--             , onClick <| SetActivePage <| UserPage <| PrenatalRecurrentParticipantPage InitiatorParticipantsPage data.participant.person
--             ]
...
--
--
-- generateActivityData : PrenatalRecurrentActivity -> AssembledData -> ( TranslationId, String )
-- generateActivityData activity data =
--     let
--         default =
--             ( Translate.PrenatalRecurrentActivitiesTitle activity, getActivityIcon activity )
--     in
--     case activity of
--         NextSteps ->
