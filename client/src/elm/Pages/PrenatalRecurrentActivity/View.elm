...
view : Language -> NominalDate -> PrenatalEncounterId -> Bool -> PrenatalRecurrentActivity -> ModelIndexedDb -> Model -> Html Msg
view language currentDate id isChw activity db model =
    ...
    -- @todo
    text "PrenatalRecurrentActivity"



-- viewHeaderAndContent : Language -> NominalDate -> PrenatalRecurrentEncounterId -> Bool -> PrenatalRecurrentActivity -> ModelIndexedDb -> Model -> AssembledData -> Html Msg
...
--
--
-- viewHeader : Language -> PrenatalRecurrentEncounterId -> PrenatalRecurrentActivity -> AssembledData -> Html Msg
-- viewHeader language id activity assembled =
--     let
--         ( label_, icon ) =
...
--             viewPrenatalRecurrentPhotoContent language currentDate assembled model.prenatalPhotoData
--
--         Laboratory ->
--             viewLaboratoryContent language currentDate assembled model.laboratoryData
--
--         Backend.PrenatalRecurrentActivity.Model.HealthEducation ->
...
--
--         Backend.PrenatalRecurrentActivity.Model.MalariaPrevention ->
--             viewMalariaPreventionContent language currentDate assembled model.malariaPreventionData
--
--         Backend.PrenatalRecurrentActivity.Model.Medication ->
...
--
--
-- viewPrenatalRecurrentPhotoContent : Language -> NominalDate -> AssembledData -> PrenatalRecurrentPhotoData -> List (Html Msg)
-- viewPrenatalRecurrentPhotoContent language currentDate assembled data =
--     let
--         photoId =
...
--                 Just url ->
--                     ( Just url
--                     , [ onClick <| SavePrenatalRecurrentPhoto assembled.participant.person photoId url ]
--                     , False
--                     )
--
--                 Nothing ->
...
--             [ class "content" ]
--             [ p [] [ text <| translate language Translate.PrenatalRecurrentPhotoHelper ]
--                 |> keyed "help"
--             , keyedDivKeyed "grid"
--                 [ class "ui grid" ]
...
--                 [ div attributes
--                     [ span [ class <| "icon-activity-task icon-" ++ iconClass ] []
--                     , text <| translate language (Translate.PrenatalRecurrentLaboratoryTask task)
--                     ]
--                 ]
--
--         formHtmlAndTasks =
...
--                                 |> viewPrenatalRecurrentRDTFormCheckKnownAsPositive language currentDate TaskHIVTest
--
--                         TaskSyphilisTest ->
--                             measurements.syphilisTest
--                                 |> getMeasurementValueFunc
--                                 |> prenatalNonRDTFormWithDefault data.syphilisTestForm
--                                 |> viewPrenatalRecurrentNonRDTForm language currentDate TaskSyphilisTest
--
--                         TaskHepatitisBTest ->
--                             measurements.hepatitisBTest
--                                 |> getMeasurementValueFunc
--                                 |> prenatalNonRDTFormWithDefault data.hepatitisBTestForm
--                                 |> viewPrenatalRecurrentNonRDTFormCheckKnownAsPositive language currentDate TaskHepatitisBTest
--
--                         TaskMalariaTest ->
--                             measurements.malariaTest
--                                 |> getMeasurementValueFunc
--                                 |> prenatalRDTFormWithDefault data.malariaTestForm
--                                 |> viewPrenatalRecurrentRDTForm language currentDate TaskMalariaTest
--
--                         TaskBloodGpRsTest ->
--                             measurements.bloodGpRsTest
--                                 |> getMeasurementValueFunc
--                                 |> prenatalNonRDTFormWithDefault data.bloodGpRsTestForm
--                                 |> viewPrenatalRecurrentNonRDTForm language currentDate TaskBloodGpRsTest
--
--                         TaskUrineDipstickTest ->
--                             measurements.urineDipstickTest
--                                 |> getMeasurementValueFunc
--                                 |> prenatalUrineDipstickFormWithDefault data.urineDipstickTestForm
--                                 |> viewPrenatalRecurrentUrineDipstickForm language currentDate
--
--                         TaskHemoglobinTest ->
--                             measurements.hemoglobinTest
--                                 |> getMeasurementValueFunc
--                                 |> prenatalNonRDTFormWithDefault data.hemoglobinTestForm
--                                 |> viewPrenatalRecurrentNonRDTForm language currentDate TaskHemoglobinTest
--
--                         TaskRandomBloodSugarTest ->
--                             measurements.randomBloodSugarTest
--                                 |> getMeasurementValueFunc
--                                 |> prenatalNonRDTFormWithDefault data.randomBloodSugarTestForm
--                                 |> viewPrenatalRecurrentNonRDTForm language currentDate TaskRandomBloodSugarTest
--                     )
--                 )
--                 tasks
--                 |> Dict.fromList
...
--                 [ div attributes
--                     [ span [ class <| "icon-activity-task icon-" ++ iconClass ] []
--                     , text <| translate language (Translate.PrenatalRecurrentNextStepsTask isChw task)
--                     ]
--                 ]
--
--         tasksCompletedFromTotalDict =
...
--                                         let
--                                             assesment =
--                                                 generatePrenatalRecurrentAssesmentForChw assembled
--                                         in
...
--             , mode = VitalsFormFull
--             , invokationModule = InvokationModulePrenatalRecurrent
--             }
--     in
...
--                             Backend.Person.Model.PrenatalRecurrentNextStepsActivityOrigin assembled.id
--             ]
...
--                                     , div [ class "prescription" ] [ text <| translate language Translate.AdministerPrenatalRecurrentMebendezoleHelper ++ "." ]
--                                     ]
--                             )
--                         |> Maybe.withDefault emptyNode
...
--
--
-- viewPrenatalRecurrentRDTFormCheckKnownAsPositive : Language -> NominalDate -> LaboratoryTask -> PrenatalRecurrentLabsRDTForm -> ( Html Msg, Int, Int )
-- viewPrenatalRecurrentRDTFormCheckKnownAsPositive language currentDate task form =
--     let
...
--         [ viewCustomLabel language (Translate.PrenatalRecurrentLaboratoryTaskLabel task) "" "label header"
--         ]
--             ++ initialSection
--             ++ derivedSection
...
--
--
-- viewPrenatalRecurrentRDTForm : Language -> NominalDate -> LaboratoryTask -> PrenatalRecurrentLabsRDTForm -> ( Html Msg, Int, Int )
-- viewPrenatalRecurrentRDTForm language currentDate task form =
--     let
...
--
--
-- prenatalRDTFormInputsAndTasks : Language -> NominalDate -> LaboratoryTask -> PrenatalRecurrentLabsRDTForm -> ( List (Html Msg), Int, Int )
-- prenatalRDTFormInputsAndTasks language currentDate task form =
--     let
--         ( initialSection, initialTasksCompleted, initialTasksTotal ) =
...
--                                                 emptyNode
--                                     in
--                                     ( [ viewLabel language <| Translate.PrenatalRecurrentLaboratoryTaskResult task
--                                       , emptyOption
--                                             :: List.map
--                                                 (\result ->
--                                                     option
...
--                                                         ]
--                                                         [ text <| translate language <| Translate.PrenatalRecurrentTestResult result ]
--                                                 )
--                                                 [ PrenatalRecurrentTestPositive, PrenatalRecurrentTestNegative, PrenatalRecurrentTestIndeterminate ]
--                                             |> select
...
--
--
-- viewPrenatalRecurrentUrineDipstickForm : Language -> NominalDate -> PrenatalRecurrentUrineDipstickForm -> ( Html Msg, Int, Int )
-- viewPrenatalRecurrentUrineDipstickForm language currentDate form =
--     let
--         ( initialSection, initialTasksCompleted, initialTasksTotal ) =
...
--                                 Translate.PrenatalRecurrentUrineDipstickTestVariant
--                           ]
...
--
--                         else
--                             [ viewCustomLabel language Translate.PrenatalRecurrentLaboratoryTaskResultsHelper "." "label" ]
--                 in
...
--         [ viewCustomLabel language (Translate.PrenatalRecurrentLaboratoryTaskLabel TaskUrineDipstickTest) "" "label header"
--         ]
--             ++ initialSection
--             ++ derivedSection
--     , initialTasksCompleted + derivedTasksCompleted
...
--
--
-- viewPrenatalRecurrentNonRDTFormCheckKnownAsPositive : Language -> NominalDate -> LaboratoryTask -> PrenatalRecurrentLabsNonRDTForm -> ( Html Msg, Int, Int )
-- viewPrenatalRecurrentNonRDTFormCheckKnownAsPositive language currentDate task form =
--     let
--         ( initialSection, initialTasksCompleted, initialTasksTotal ) =
--             contentAndTasksLaboratoryTestKnownAsPositive language currentDate task form
--
...
--
--
-- viewPrenatalRecurrentNonRDTForm : Language -> NominalDate -> LaboratoryTask -> PrenatalRecurrentLabsNonRDTForm -> ( Html Msg, Int, Int )
-- viewPrenatalRecurrentNonRDTForm language currentDate task form =
--     let
--         ( inputs, tasksCompleted, tasksTotal ) =
--             prenatalNonRDTFormInputsAndTasks language currentDate task form
--     in
...
--
--
-- prenatalNonRDTFormInputsAndTasks : Language -> NominalDate -> LaboratoryTask -> PrenatalRecurrentLabsNonRDTForm -> ( List (Html Msg), Int, Int )
-- prenatalNonRDTFormInputsAndTasks language currentDate task form =
--     let
--         ( initialSection, initialTasksCompleted, initialTasksTotal ) =
--             contentAndTasksLaboratoryTestInitial language currentDate task form
...
--             , executionNote : Maybe PrenatalRecurrentTestExecutionNote
--         }
--     -> ( List (Html Msg), Int, Int )
-- contentAndTasksLaboratoryTestInitial language currentDate task form =
--     let
...
--                                     Translate.PrenatalRecurrentTestExecutionNote
--                                 ]
--                           ]
...
--                                     )
--                         in
--                         ( (viewLabel language <| Translate.PrenatalRecurrentLaboratoryTaskDate task)
