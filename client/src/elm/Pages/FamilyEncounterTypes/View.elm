module Pages.FamilyEncounterTypes.View exposing (view)
    ...
    let
        encounterButton encounterType =
            button
                ...
                , onClick <| SetActivePage <| UserPage <| FamilyEncounterParticipantsPage encounterType
                ]
                [ span [ class "text" ] [ text <| translate language <| Translate.FamilyEncounterType encounterType ]
                , span [ class "icon-back" ] []
                ]
