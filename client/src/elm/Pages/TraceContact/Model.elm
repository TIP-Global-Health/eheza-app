module Pages.TraceContact.Model exposing (Model, Msg(..), NoContactReason(..), RecordSymptomsPopupState(..), StepInitiateContactData, StepRecordSymptomsData, SymptomsGIForm, SymptomsGeneralForm, SymptomsRespiratoryForm, TraceContactStep(..), emptyModel, emptyStepInitiateContactData, emptyStepRecordSymptomsData)
