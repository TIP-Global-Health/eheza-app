...
# Not measured: tests, whose scenarios need room to explain; code that is
# generated or copied from elsewhere; and the notes Claude Code sessions keep.
SKIP = (
    "*/Test.elm",
    "*/tests/*",
    "/client/e2e/*",
    "/client/src/elm/TestFixtures.elm",
    "/scalability-test/*",
    "/server/hedley/HedleyWebTestBase.inc",
    "/.ddev/config.yaml",
    "/client/src/elm/AssocList.elm",
    "/server/hedley/modules/custom/hedley_general/js/elm-main.js",
    "/.claude/*",
    "/docs/superpowers/*",
)
