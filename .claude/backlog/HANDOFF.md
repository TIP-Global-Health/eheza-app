...
🟡 **PR #2285 open 2026-09-23 (B-241, tier 3, issue #2284)** — Prenatal: the continued-care hypertension block (previously diagnosed patients) shows at the initial phase only, per issue #256; at the recurrent phase it no longer locks Save. One source line + 2 elm-tests (discriminating). Worktree released. ✅ **CI fully green on `d5b292767` (all 11 checks).** Awaiting review.
