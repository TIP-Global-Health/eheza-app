...
- **Before release #2128 is cut, three findings bear on it:** B-336 (stranded — ✅ landed via #2239), **B-339** and **B-342** (tier-1 defects introduced by #2216 and #2228, both un-deployed — fixing them now keeps them out of production), and **B-341** (add the photo-repair run to #2128's post-deploy steps, plus the beverages re-run reminder).
