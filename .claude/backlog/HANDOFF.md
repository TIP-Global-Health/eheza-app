...
📌 Tier 1 READY after B-392 shipped (PR #2273): **B-422** only (B-421 shipped 2026-09-22 as PR #2275). ⭐ **Tier 2 is not empty any more** — the 2026-09-01 note below saying so is superseded. R28 refilled it: **B-195** (half on hold as #2156, ⛔ do not re-pitch), **B-308**, **B-311**, **B-317**. Tier 1 READY after B-240 shipped: **B-286, B-288, B-289, B-319, B-320, B-323** — the last two cluster with this one and with B-237 on the same prenatal HIV surface.
