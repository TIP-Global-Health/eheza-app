...
🔎 **R36 discovery IN PROGRESS 2026-09-22** — 5 scouts fanned out at 76e4d3e04 (sub-updaters, NCDA cross-side, dashboard stats cross-side, person search/enrolment, expectActivity vs completion); see `rounds.md` Round 36. If this line is still here, the round was cut short — the per-unit results recorded under Round 36 are what survived.
